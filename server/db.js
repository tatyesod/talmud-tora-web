...
const migrations = [
  ...
  // תפקיד המשתמש. ריק/NULL = משתמש רגיל (מזכיר/מנהל), כמו כל המשתמשים
  ...
  // השלוחה של המשתמש. 3CX אינה שולחת לאיזו שלוחה הגיעה השיחה, ולכן
  // כל מחשב מקבל כתובת עם השלוחה שלו קבועה בתוכה, והשיוך נעשה כאן.
  // בלי זה כל משתמש רואה את השיחות של כולם - כולל שיחות רגישות.
  ...
  "ALTER TABLE families ADD COLUMN father_synagogue TEXT",
  // הסיווג שנבחר במסך "מקום לימוד / תפילה": study / prayer / both.
